          ...
          <div className="flex-1">
            <nav className="grid items-start px-2 text-sm font-medium lg:px-4">
              ...
              <Link
                to="/expense-category"
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${
                  location.pathname === "/expense-category" ? "bg-muted text-primary" : "text-muted-foreground hover:text-primary"
                }`}
              >
                <Weight className="h-4 w-4" />
                ExpenseCategory
              ...
              <Link
                to="/expense"
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${
                  location.pathname === "/expense" ? "bg-muted text-primary" : "text-muted-foreground hover:text-primary"
                }`}
              >
                <Weight className="h-4 w-4" />
                Expense
              ...
              <Link
                to="/product"
                className={`flex items-center gap-3 rounded-lg px-3 py-2 transition-all ${
                  location.pathname === "/product" ? "bg-muted text-primary" : "text-muted-foreground hover:text-primary"
                }`}
              >
                <Weight className="h-4 w-4" />
                Product
