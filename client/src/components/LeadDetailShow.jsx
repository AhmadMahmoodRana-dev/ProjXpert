...
const CompanyDetailShow = () => {
  const { leadDetail, openLeadDetail, setOpenLeadDetail } =
    useContext(Context);
  return (
    <Dialog
      open={openLeadDetail}
      onClose={setOpenLeadDetail}
            ...
            >
              <TransitionChild>
                <div className="absolute left-0 top-0 -ml-8 flex pr-2 pt-4 duration-500 ease-in-out data-[closed]:opacity-0 sm:-ml-10 sm:pr-4">
                  <button
                    type="button"
                    onClick={() => setOpenLeadDetail(false)}
              ...
              <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl px-4">
                ...
                <h1 className="mt-4 font-bold text-4xl italic text-gray-600">{`${leadDetail.name}`}</h1>
                <hr className="border border-gray-300 mt-6" />
